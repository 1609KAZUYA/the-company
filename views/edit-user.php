...
<body>
  ...
  <form action="../actions/update-user.php" method="post" class="my-5 mx-auto w-50">
    <h2 class="h5 text-center text-uppercase">Edit User</h2>

    <input type="hidden" name="user_id" value="<?= $user_data['id'] ?>">

    <label for="first-name" class="form-label">First Name</label>
    <input type="text" name="first_name" id="first_name" class="form-control mb-2" value="<?= $user_data['first_name'] ?>">

    <label for="last-name" class="form-label">Last Name</label>
    <input type="text" name="last_name" id="last_name" class="form-control mb-2" value="<?= $user_data['last_name'] ?>">
